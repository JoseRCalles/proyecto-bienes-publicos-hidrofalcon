<div class="modal micromodal-slide" id="desincorporation-modal" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-title-desincorporation">
            
            <header class="modal__header">
                <h6 class="modal__title" id="modal-title-desincorporation">Desincorporación de Activos</h6>
                <button class="modal__close" aria-label="Cerrar modal" data-micromodal-close>&times;</button>
            </header>

            <div class="modal__content">
                <form action="" class="enter-data" id="desincorporar-form">
                    <div class="asset-selection-container">
                        <div class="head-input__container" id="asset-input-container__desincorporation">
                            <div class="asset-input__container">
                                <label for="display_asset_name__desincorporation" class="label-input asset-label">Activo Fijo a Desincorporar</label>
                                <input type="text" id="display_asset_name__desincorporation" name="asset_asignado_display__desincorporation" class="input input-asset" readonly placeholder="Seleccione un activo fijo">
                                <div class="search-container">
                                    <button type="button" id="toggle-asset-search-btn__desincorporation" class="btn-search-asset" style="flex-shrink: 0;">Buscar Activo</button>
                                </div>
                            </div>
                            <input type="hidden" name="asset_id__desincorporation" id="hidden_asset_id__desincorporation">
                            <div class="err-asset err-box" id="err-asset__desincorporation"></div>
                        </div>
                    </div>

                    <section id="asset-search-section__desincorporation" class="asset-search-section">
                        <div class="search-controls">
                            <input class='input table-asset__input' type="text" id="asset-search-input__desincorporation" placeholder="Código, serial, marca o modelo...">
                            <select id="estatus-filter__desincorporation" class='input table-asset__input select-asset'>
                        ...
                        <div class="asset-results__container">
                            <table class="asset-table">
                                <thead>
                                    <tr id="asset-table-headers__desincorporation">
                                        <th>Código Activo</th>
                                        <th>Serial</th>
                                        <th>Marca</th>
                                        <th>Modelo</th>
                                ...
                                <tbody id="asset-table-body__desincorporation"></tbody>
                            </table>
                            <p id="no-asset-results-message__desincorporation" style="display: none;">No se encontraron activos fijos.</p>
                        </div>
                        <div class="pagination-controls">
                            <button type="button" id="prev-asset-page-btn__desincorporation" class="page-btn" disabled>
                            ...
                            <button type="button" id="next-asset-page-btn__desincorporation" class="page-btn" disabled>
                            ...
                            <span id="asset-page-info__desincorporation" style="display: none;">Página 1 de 1</span>
                            <div id="asset-page-numbers__desincorporation" style="display: inline-block;" class="page-numbers"></div>
                        </div>
                    </section>

                    <div class="extra-actions">
                        <input class="button submit-button" type="submit" id="desincorporar-submit" value="Asignar Activo">
                    </div>
                </form>
            </div>
