...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const excelModalId = 'incorporation-excel-upload-modal';
    const form = document.getElementById('incorporation-excel-upload-form');
    const fileInput = document.getElementById('incorporation-file-input');
    const submitButton = document.getElementById('incorporation-submit-btn');
    const messageContainer = document.getElementById('incorporation-message-container');
    const resultsContainer = document.getElementById('incorporation-results-container');
