<div class="modal micromodal-slide" id="incorporation-modal" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" >
        <div class="modal__container" id="incorporation-modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-title">
            ...
            <div class="modal__content">
                <div class="employee-selection-container">
                    <div class="head-input__container" id="err-em-box">
                        <div class="employee-input__container">
                            <label for="display_employee_name" class="label-input employee-label">Trabajador Asignado</label>
                            <input type="text" id="display_employee_name" class="input input-employee" readonly placeholder="Seleccione un trabajador">
                            <div class="err-employee err-box" id="err-employee_incorporation"></div>

                            <input type="hidden" name="trabajador_id_common" id="hidden_employee_id_common">

                            <div class="search-container">
                                <button type="button" id="toggle-search-employee-btn__incorporation" class="btn-search-employee" style="flex-shrink: 0;">Buscar</button>
                            </div>
                        </div>
                ...
                <section id="employee-search-section" class="employee-search-section">
                    <div class="search-controls">
                        <input class='input table-employee__input' type="text" id="employee-search-input" placeholder="Cédula, nombre o apellido...">
                        <select id="gerencia-filter" class='input table-employee__input select-employee'>
                    ...
                    <div class="employee-results__container">
                        <table class="employee-table">
                            <thead>
                                <tr id="employee-table-headers"></tr>
                                <th>Cedula</th>
                                <th>Nombres</th>
                                <th>Apellidos</th>
                                <th>Telefono</th>
                        ...
                        <p id="no-results-message">No se encontraron trabajadores.</p>
                    </div>

                    <div class="pagination-controls">
                        <button id="prev-page-btn__incorporation" class="page-btn" disabled>
                        ...
                        <button id="next-page-btn__incorporation" class="page-btn" disabled>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span id="page-info" style="display: none;">Página 1 de 1</span>
                        <div id="page-numbers__incorporation" style="display: inline-block;" class="page-numbers"></div>
                    </div>
                </section>

                <div class="switch-container">
                    <div class="switch-option active" id="option-nuevo">Nuevo</div>
                    <div class="switch-option" id="option-existente">Existente</div>
                    <div class="switch-indicator" id="switch-indicator"></div>
                </div>

                <form id="new-asset-form__incorporation" action="/systemahidrofalcon/backend/user-actions/properties/add-property.php" method="POST" class="enter-data casenew-container show">
                    ...
                    <div class="frstpart-container show">
                        ...
                        <div class="text-inputs">
                            <div class="input-container">
                                ...
                                <input type="text" name="cod_act_f" id="cod_act_f__incorporation" class="input">
                                <div class="err-cod_act_f err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="color" class="label-input">Color</label>
                                <input type="text" name="color" id="color__incorporation" class="input">
                                <div class="err-color err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="marca" class="label-input">Marca</label>
                                <input type="text" name="marca" id="marca__incorporation" class="input">
                                <div class="err-marca err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="modelo" class="label-input">Modelo</label>
                                <input type="text" name="modelo" id="modelo__incorporation" class="input">
                        ...
                        <div class="text-inputs">
                            <div class="input-container">
                                ...
                                <select type="text" name="sede_adm" id="sede_adm__incorporation" class="input">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="descripcion" id="descripcion__incorporation" class="input">
                                <div class="err-descripcion err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="serial" class="label-input">Serial</label>
                                <input type="text" name="serial" id="serial__incorporation" class="input">
                                <div class="err-serial err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="estatus_new" class="label-input">Estatus</label>
                                <select name="estatus" id="estatus_new__incorporation" class="input status-newIncorporation">
                                    <option value="">Seleccione un estatus</option>
                                </select>
                    ...
                    <div class="scndpart-container">
                        <div class="text-inputs">
                            <div class="input-container">
                                ...
                                <input type="text" name="observacion" id="observacion__incorporation" class="input">
                                <div class="err-observacion err-box"></div>
                            </div>
                            <div class="input-container">
                                <label for="doc" class="label-input">Documento</label>
                                <input type="text" name="doc" id="documento__incorporation" class="input">
                                <div class="err-doc err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="monto" class="label-input">Monto</label>
                                <input type="text" name="monto" id="monto__incorporation" class="input">
                        ...
                        <div class="text-inputs">
                            <div class="input-container">
                                <label for="codigo_u_u" class="label-input">Unidad</label>
                                <input type="text" name="codigo_u_u" id="codigo_u_u__incorporation" class="input">
                                <div class="err-codigo_u_u err-box"></div>
                            </div>

                            <div class="input-container">
                                <label for="fecha" class="label-input">Fecha</label>
                                <input type="text" name="fecha" id="fecha__incorporation" class="input">
                                <div class="err-fecha err-box"></div>
                            </div>
                        </div>

                        <div class="extra-actions" id="extra-actions__incorporation">
                            <button type="button" class="button goback-button">
                                Volver
                            </button>
                            <input class="button submit-button" id="submit-button__incorporation" type="submit" value="Registrar Nuevo Activo">
                        </div>
                    </div>
                </form>

                <form id="existing-asset-form" method="POST" class="enter-data caseexisting-container">
                    <input type="hidden" name="trabajador_id" id="trabajador_id_existing_asset_form">

                    <div class="asset-selection-container">
                        <div class="head-input__container" id="asset-input-container">
                            <div class="asset-input__container">
                                <label for="display_asset_name" class="label-input asset-label">Activo Fijo Asignado</label>
                                <input type="text" id="display_asset_name" name="asset_asignado_display" class="input input-asset" readonly placeholder="Seleccione un activo fijo">
                                <div class="err-asset err-box"></div>

                                <div class="search-container">
                                    <button type="button" id="toggle-asset-search-btn" class="btn-search-asset" style="flex-shrink: 0;">Buscar Activo</button>
                                </div>
                            </div>
                    ...
                    <section id="asset-search-section" class="asset-search-section">
                        <div class="search-controls">
                            <input class='input table-asset__input' type="text" id="asset-search-input" placeholder="Código, serial, marca o modelo...">
                            <select id="estatus-filter" class='input table-asset__input select-asset'>
                        ...
                        <div class="asset-results__container">
                            ...
                            <p id="no-asset-results-message" style="display: none;">No se encontraron activos fijos.</p>
                        </div>

                        <div class="pagination-controls">
                            <button type="button" id="prev-asset-page-btn__incorporation" class="page-btn" disabled>
                            ...
                            <button type="button" id="next-asset-page-btn__incorporation" class="page-btn" disabled>
                            ...
                            <span id="asset-page-info" style="display: none;">Página 1 de 1</span>
                            <div id="asset-page-numbers__incorporation" style="display: inline-block;" class="page-numbers"></div>
                        </div>
                    </section>
                    <div class="extra-actions">
                        <input class="button submit-button" type="submit" id="existing-submit" value="Asignar Activo">
                    </div>
                </form>
            </div>
        </div>
