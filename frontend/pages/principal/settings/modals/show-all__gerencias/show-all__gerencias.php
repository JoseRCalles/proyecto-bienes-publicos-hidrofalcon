<div class="modal micromodal-slide" id="showAll-modal__gerencias" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" >
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-title">

            <header class="modal__header">
                <h6 class="modal__title" id="modal-title">Gerencias</h6>
                <button class="modal__close" aria-label="Cerrar modal" data-micromodal-close>&times;</button>
            </header>

            <div class="modal__content">
                <div class="search-controls">
                    <form action="" method="get" class="allAssets-searchbar-form" id="allAssetsSearchForm__gerencias">
                        <div class="searchpart">
                            <div class="searchbar__controls searchbar__showAll">
                                <input type="text" placeholder="Buscar" class="allAssets__searchbar properties__searchbar" id="allAssetsSearchInput__gerencias">
                ...
                <div class="allAssets-results">
                    <div id="allAssetsErrorMessage__gerencias" class="error-message" style="display: none;">
                        <p></p>
                    </div>
                    <table id="allAssetsTable__employees">
                        <thead>
                            <tr id="allAssetsTableHeaderRow__gerencias">
                            </tr>
                        </thead>
                        <tbody id="allAssetsTableBodygerencias__gerencias">
                            </tbody>
                    </table>
                </div>

                <div class="modal-actions">
                    <button class="button button-exportar-excel" id="exportAllAssetsExcelButton__gerencias">Descargar Excel</button>
                </div>
            </div>
            </div>
        </div>
