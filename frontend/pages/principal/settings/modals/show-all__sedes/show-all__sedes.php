<div class="modal micromodal-slide" id="showAll-modal__sedes" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" >
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-title">

            <header class="modal__header">
                <h6 class="modal__title" id="modal-title">Sedes</h6>
                <button class="modal__close" aria-label="Cerrar modal" data-micromodal-close>&times;</button>
            </header>

            <div class="modal__content">
                <div class="search-controls">
                    <form action="" method="get" class="allAssets-searchbar-form" id="allAssetsSearchForm__sedes">
                        <div class="searchpart">
                            <div class="searchbar__controls searchbar__showAll">
                                <input type="text" placeholder="Buscar" class="allAssets__searchbar properties__searchbar" id="allAssetsSearchInput__sedes">
                ...
                <div class="allAssets-results">
                    <div id="allAssetsErrorMessage__sedes" class="error-message" style="display: none;">
                        <p></p>
                    </div>
                    <table id="allAssetsTable__sedes">
                        <thead>
                            <tr id="allAssetsTableHeaderRow__sedes">
                            </tr>
                        </thead>
                        <tbody id="allAssetsTableBodyemployees__sedes">
                            </tbody>
                    </table>
                </div>
